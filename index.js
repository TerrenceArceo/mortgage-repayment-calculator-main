...
resultsHtml.innerHTML = `
    ...
    <h2 class="empty-result-title">Results shown here</h2>
    <p class="empty-result-subtitle">Complete the form and click "calculate repayments" to see what your monthly repayments would be.</p>
`